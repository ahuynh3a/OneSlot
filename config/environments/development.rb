...
Rails.application.configure do
  config.after_initialize do
    Bullet.enable = true               # Enable Bullet gem, essential
    Bullet.alert = true                # JavaScript alerts for the browser
    ...
    Bullet.rails_logger = true         # Adds warnings directly to the Rails log
